...
export default function Home() {
    ...
    const { isCorrect, showConfetti } = ans
    const [parentDivDimensions, setParentDivDimensions] = useState({
        height: 0,
        width: 0
    })
    const { height, width } = parentDivDimensions
    useEffect(() => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col layout-container items-center justify-around w-full bg-black text-white p-4">
